 ...
 * @author Ale
 */
public class PrenominaRespuesta {

    private List<PrenominaDTO> contenido;
    ...
    public PrenominaRespuesta() {
    }

    public List<PrenominaDTO> getContenido() {
        return contenido;
    }

    public void setContenido(List<PrenominaDTO> contenido) {
