 ...
 * @author Ale
 */
public class HojaFirmaRespuesta {

    private List<HojaFirmaDTO> contenido;
    ...
    public HojaFirmaRespuesta() {
    }

    
    public List<HojaFirmaDTO> getContenido() {
        return contenido;
    }

    public void setContenido(List<HojaFirmaDTO> contenido) {
