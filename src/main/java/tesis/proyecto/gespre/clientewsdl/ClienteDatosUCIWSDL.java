...
import services.ObtenerPersonaDadoCodigoBarras;
...
public class ClienteDatosUCIWSDL extends WebServiceGatewaySupport {
    ...
    public ObtenerPersonaDadoCodigoBarrasResponse obtenerPersonaDadoCodigoBarra(String codigoBarra) {
        
        ObjectFactory factory = new ObjectFactory();
        
        ObtenerPersonaDadoCodigoBarras barras = factory.createObtenerPersonaDadoCodigoBarras();
        
        barras.setCodigoBarras(factory.createObtenerPersonaDadoCodigoBarrasCodigoBarras(codigoBarra));
        
        ObtenerPersonaDadoCodigoBarrasResponse response =(ObtenerPersonaDadoCodigoBarrasResponse) getWebServiceTemplate().marshalSendAndReceive(barras);     
     return response;
    }
